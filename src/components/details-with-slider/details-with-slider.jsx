...
export default function DetailsWithSlider({ data }) {
  const router = useRouter();

  
  const tourPackageDetails = data;

  //   --------------------- Add tour to cart ---------------------
  function addToCart() {
    // add the tour to Cart Store -- Make the code here
    router.push('/home'); // Navigate to /cart
