...
(function ($) {
  ...
  $(".date-time-dropdown-single").daterangepicker({
    singleDatePicker: true, // 👈 This makes it act like a regular date picker
...
//   });
  ...
  const themeModeAction = () => {
    if (localStorage.theme === "dark") {
      $(".change-theme-mode i").attr("class", "ri-moon-line", "ri-sun-line");
    } else {
      $(".change-theme-mode i").attr("class", "ri-sun-line", "ri-moon-line");
    }
  };
  themeModeAction();
  //Toggle Buttons
  ...
  $(document).on("click", ".close-sidebar, .sidebar-body-overlay", function () {
    $(
      ".panel-sidebar-close, .sidebar-users-dashboard, .sidebar-body-overlay"
    ).removeClass("active");
  });
